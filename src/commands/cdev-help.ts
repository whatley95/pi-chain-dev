...
export const CDEV_SUBCOMMAND_HELP = [
  ...
  "/cdev grep <pattern> [path]  Scout-search codebase for pattern",
  "/cdev trace <symbol>    Scout-trace definition and usages of a symbol",
  "/cdev explain <target>  Scout-explain a file or symbol",
