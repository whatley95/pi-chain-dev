...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "Use cdev with yolo:true to run scout+forge followed by automatic review-fix loops (configurable via /cdev yolo on|off). Stop early and escalate to the user if reviews keep failing.",
